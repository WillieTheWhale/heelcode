...
export const RootHttpApi = HttpApi.make("heelcode-root")
...
export const InstanceHttpApi = HttpApi.make("heelcode-instance")
...
export const OpenCodeHttpApi = HttpApi.make("heelcode")
