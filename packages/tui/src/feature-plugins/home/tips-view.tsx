...
const NO_MODELS_TIP =
  "PromptLab is not connected. Log in to PromptLab in Chrome, then restart {highlight}heelcode{/highlight}"
...
const TIPS: Tip[] = [
  ...
  "Use {highlight}/models{/highlight} to choose from the PromptLab model catalog",
  ...
  "Create {highlight}opencode.json{/highlight} for heelcode server settings and {highlight}tui.json{/highlight} for TUI settings",
  ...
  "Create a plugin to prevent heelcode from reading sensitive files",
  "Use {highlight}heelcode run{/highlight} for non-interactive scripting",
  "Use {highlight}heelcode --continue{/highlight} to resume the last session",
  "Use {highlight}heelcode run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}heelcode serve{/highlight} for headless API access to heelcode",
  "Use {highlight}heelcode run --attach{/highlight} to connect to a running server",
  "Run {highlight}heelcode upgrade{/highlight} to update to the latest version",
  "Run {highlight}heelcode auth list{/highlight} to see all configured providers",
  "Run {highlight}heelcode agent create{/highlight} for guided agent creation",
  "Use {highlight}/heelcode{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}heelcode github install{/highlight} to set up the GitHub workflow",
  "Comment {highlight}/heelcode fix this{/highlight} on issues to auto-create PRs",
  ...
  "Run {highlight}heelcode debug config{/highlight} to troubleshoot configuration",
  ...
  "Use the local {highlight}heelcode{/highlight} binary for this PromptLab-backed fork",
  "Use {highlight}/models{/highlight} to choose from PromptLab models",
